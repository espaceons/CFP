...
urlpatterns = [
    ...
    path('seance/<int:session_pk>/seances/<int:pk>/', views.SeanceDetailView.as_view(), name='seance_detail'),
    
    # URL pour ajouter PLUSIEURS séances à une session (vue fonctionnelle)
    path('sessions/<int:session_pk>/seances/ajouter_multiple/', views.ajouter_plusieurs_seances, name='seance_create_multiple'),
    ...
    path('calendar/', SeanceCalendarPageView.as_view(), name='seance_calendar_page'),
